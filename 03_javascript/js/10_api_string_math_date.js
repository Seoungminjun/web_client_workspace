 ...
 * - prompt통해 임의의 문자열을 받고, 알파벳개수를 세서 출력하기
 */
function test2() {
    const str = prompt("알파벳을 입력하세요");
    if(!str){
...
function test4(){
    ...
    for(let i = 0; i < list.length; i++){
        list[i].style.color = 'initial' // inutial | inherit
...
function test5(){
    ...
    const date = new Date(1700460430406); // UTC Time을 Date객체 생성하기
    console.log(date);
