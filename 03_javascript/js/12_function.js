// test1();
// 함수선언식 정상작동
// 함수표현식 오류남 : Uncaught ReferenceError: Cannot access 'test1' before initialization
...
// 매개변수 parameter (선언부) 매개인자가 담길 공간 text
// 매개인자 argument (호출부) 함수에 전달할 값 고기
(function(text){
    console.log(text);
})('🥩🥩🥩');
